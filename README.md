...
<!-- Replace YOUR_PROGRAM_ID after: anchor deploy + solana-verify -->
<!-- ============================================================ -->

<!-- solana-verify badge (OtterSec) — shows green checkmark once verified -->
[![Solana Verify](https://verify.osec.io/status/YOUR_PROGRAM_ID?style=flat-square)](https://verify.osec.io/status/YOUR_PROGRAM_ID)

<!-- Explorer links — replace YOUR_PROGRAM_ID after anchor deploy -->
...
<!-- ============================================================ -->
<!-- BADGE ROW 3 — Build, Audit & Repo Health                     -->
<!-- ============================================================ -->
...
<!-- ============================================================ -->
<!-- BADGE ROW 4 — Infrastructure & Monitoring                    -->
<!-- ============================================================ -->
...
```bash
# Verify the CPAMM program yourself
...
> Replace `YOUR_PROGRAM_ID` with the deployed program address after `anchor deploy --provider.cluster mainnet-beta`.
